...
pub struct ActivityEvent {
    ...
    pub remote_operation_sha256: Option<String>,
...
impl From<&ActivityEvent> for ActivitySummary {
    fn from(event: &ActivityEvent) -> Self {
        Self {
            ...
            remote_operation_sha256: event.remote_operation_sha256.clone(),
            state: event.state,
...
struct ActivityEventWire {
    ...
    remote_operation_sha256: Option<String>,
...
validate_wire!(
    ...
    |wire: ActivityEventWire| ActivityEvent {
        ...
        remote_operation_sha256: wire.remote_operation_sha256,
...
validated_serialize!(ActivityEvent, ActivityEventWire, |value: &ActivityEvent| {
    ActivityEventWire {
        ...
        remote_operation_sha256: value.remote_operation_sha256.clone(),
